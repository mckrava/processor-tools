...
describe('Store Plain Methods', function () {
    describe('.save()', function () {
        ...
        it('saving of a single entity', async function () {
            ...
            await store.save(new model_1.Item('1', 'a', '42'));
            await (0, expect_1.default)((0, util_1.getItems)()).resolves.toEqual([{ id: '1', name: 'a', foo: '42' }]);
        });
...
//# sourceMappingURL=storePlainMethods.test.js.map