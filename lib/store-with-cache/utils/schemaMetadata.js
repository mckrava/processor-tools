...
class SchemaMetadata {
    ...
    generateEntitiesOrderedList() {
        ...
        (0, innerUtils_1.renderLogs)(`schemaModel => ${JSON.stringify(this._schemaModel)}`, 'schema_metadata');
        (0, innerUtils_1.renderLogs)(`entitiesOrderedList => ${JSON.stringify(graph.sortedVertexesListBFS)}`, 'schema_metadata');
        (0, innerUtils_1.renderLogs)(`entitiesRelationsTree => ${JSON.stringify(Object.fromEntries(graph.vertexesTreeFull))}`, 'schema_metadata');
    }
}
