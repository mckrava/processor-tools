...
class SchemaMetadata {
    ...
    generateEntitiesOrderedList() {
        ...
        (0, innerUtils_1.renderLogs)(`entitiesOrderedList => ${JSON.stringify(graph.sortedVertexesListBFS)}`);
        (0, innerUtils_1.renderLogs)(`entitiesRelationsTree => ${JSON.stringify(Object.fromEntries(graph.vertexesTreeFull))}`);
    }
}
